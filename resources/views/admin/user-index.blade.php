            ...
            <form method="GET" action="{{ route('admin.users.index') }}" class="row g-3 mb-4">
                <div class="col-md-4">
                    <input type="text" name="search" value="{{ request('search') }}" class="form-control"
                        placeholder="नाव / ई-मेल शोधा">
                </div>
                <div class="col-md-2">
                    <button type="submit" class="btn btn-primary px-4 w-100">शोधा</button>
                </div>
                <div class="col-md-3">
                    <a href="{{ route('members.index') }}" class="btn btn-outline-secondary px-4 w-100">← सदस्य यादीकडे परत
                        जा</a>
                </div>
            </form>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped align-middle">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center">कोणतेही वापरकर्ते सापडले नाहीत.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
